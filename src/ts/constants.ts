...
const caseAsyncScriptMap = {
    // 创建
    '普通的地球': () => import('@/case/创建/普通的地球'),
    '纯粹的地球': () => import('@/case/创建/纯粹的地球'),
    '生成建筑物': () => import('@/case/创建/生成建筑物'),
    '地形': () => import('@/case/创建/地形'),
    // 相机
    '飞到一个位置': () => import('@/case/相机/飞到一个位置'),
    '打印某个地点的位置': () => import('@/case/相机/打印某个地点的位置'),
    '飞到指定实体上': () => import('@/case/相机/飞到指定实体上'),
    '缓动函数': () => import('@/case/相机/缓动函数'),
    '锁定到某个点': () => import('@/case/相机/锁定到某个点'),
    '围绕一个点运行': () => import('@/case/相机/围绕一个点运行'),
    // 功能
    '动态时间': () => import('@/case/功能/动态时间'),
    'CallbackProperty': () => import('@/case/功能/CallbackProperty'),
    '飞行结束执行动画': () => import('@/case/功能/飞行结束执行动画'),
    '视频投影': () => import('@/case/功能/视频投影'),
    '按距离显示': () => import('@/case/功能/按距离显示'),
    '贴图为地球皮肤': () => import('@/case/功能/贴图为地球皮肤'),
    '显示与隐藏实体': () => import('@/case/功能/显示与隐藏实体'),
    '3D瓦砖功能样式': () => import('@/case/功能/3D瓦砖功能样式'),
    '构建飞行跟踪器': () => import('@/case/功能/构建飞行跟踪器'),
    // 材质
    '颜色': () => import('@/case/材质/颜色'),
    '图片': () => import('@/case/材质/图片'),
    '棋盘': () => import('@/case/材质/棋盘'),
    '条纹': () => import('@/case/材质/条纹'),
    '网格': () => import('@/case/材质/网格'),
    '发光的线': () => import('@/case/材质/发光的线'),
    '带轮廓的线': () => import('@/case/材质/带轮廓的线'),
    // 几何形状
    '点': () => import('@/case/几何形状/点'),
    '画一条线': () => import('@/case/几何形状/画一条线'),
    '各种线': () => import('@/case/几何形状/各种线'),
    '走廊': () => import('@/case/几何形状/走廊'),
    '平面': () => import('@/case/几何形状/平面'),
    '圆与椭圆': () => import('@/case/几何形状/圆与椭圆'),
    '圆锥与圆柱': () => import('@/case/几何形状/圆锥与圆柱'),
    '各种球': () => import('@/case/几何形状/各种球'),
    '盒子': () => import('@/case/几何形状/盒子'),
    '多边形': () => import('@/case/几何形状/多边形'),
    '折线体': () => import('@/case/几何形状/折线体'),
    '墙体': () => import('@/case/几何形状/墙体'),
    // 标记
    '地图别针': () => import('@/case/标记/地图别针'),
    '标签': () => import('@/case/标记/标签'),
    '放置html元素': () => import('@/case/标记/放置html元素'),
    // 3D模型
    '创建模型': () => import('@/case/3D模型/创建模型'),
    // 数据源
    'GeoJson和TopoJson': () => import('@/case/数据源/GeoJson和TopoJson'),
    'Wmst': () => import('@/case/数据源/Wmst'),
}
